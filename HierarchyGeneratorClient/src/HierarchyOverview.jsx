    ...
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg px-2 pt-5">
      ...
      >
        <span className="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
          Showing{" "}
          <span className="font-semibold text-gray-900 dark:text-white">{calculateRangeStart(hierarchyList)}-{calculateRangeEnd(hierarchyList)}</span>{" "}
          of{" "}
          <span className="font-semibold text-gray-900 dark:text-white">{hierarchyList.meta.total} </span>hierarchies
        </span>
